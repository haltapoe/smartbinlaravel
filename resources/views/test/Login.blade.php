...
<head>
    ...
    <link href="http://127.0.0.1:8000/dist/css/Login.css" rel="stylesheet">
    ...
    <div class="w-100">
        <div class="row">
            <form action="http://127.0.0.1:8000/login" method="POST"
                ...
                <input type="hidden" name="_token" value="IIP9VsLOcu7JplcmiD8BgUMH2T7mwTqqbH2ja7l3">
                <div class="w-100 p-5">
                    <!-- Inside the form -->
                    ...
                    <div class="input-group input-group-lg mb-4">
                        ...
                        <span class="input-group-text" id="btnPass"><i class="fa fa-eye-slash"
                                id="iconPass"></i></span>
                    </div>
                    ...
                    <div class="d-flex justify-content-center">
                        <button type="submit" class="btn btn-lg btn-info bg-teal text-white px-5 fs-3 rounded-pill"
                            style="background: #00b5b8;">Sign In</button>
                    </div>
                </div>
            </form>
            <div class="col-md-6">
                <img src="http://127.0.0.1:8000/img/istockphoto685841844612x612-1@2x.png" alt="img" width="100%">
            </div>
        </div>
    </div>
